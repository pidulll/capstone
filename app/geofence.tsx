...
export default function GeofenceScreen() {
  ...
  // Monitor geofence breach status
  useEffect(() => {
  ...
  return (
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View style={styles.container}>
        {/* Search Bar for Geofence Creation/Editing */}
        {(isCreating || isEditing) && (
        ...
        <View style={styles.mapContainer}>
          ...
          {(isCreating || isEditing) && childLocation && (
            <Pressable style={styles.centerButton} onPress={handleCurrentLocation}>
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <TextInput
                ...
                autoFocus={true}
                maxLength={50}
                onSubmitEditing={isCreating ? saveGeofence : updateGeofence}
              />
              <View style={styles.modalButtons}>
                ...
                <Pressable style={styles.modalSaveButton} onPress={isCreating ? saveGeofence : updateGeofence}>
