...
import { auth, db } from '../firebase'; // Import db
    ...
    function AuthGuard({ children }: { children: React.ReactNode }) {
      ...
      const isLocationHistoryScreen = segments[segments.length - 1] === 'locationHistory'; // New: Location History Screen
      ...
      useEffect(() => {
        ...
        if (user && !inAuthGroup) {
          ...
          if (isPaired) {
            ...
            if (isMapScreen || isGeofenceScreen || isAudioRecordingsScreen || isLocationHistoryScreen) { // New: Include Location History
      ...
      }, [user, loading, isPaired, pairingLoading, inAuthGroup, isMapScreen, isSettingsScreen, isGeofenceScreen, isAudioRecordingsScreen, isLocationHistoryScreen]); // New: Include Location History
      ...
      return (
        <AuthGuard>
          ...
          >
            ...
            />
            <Stack.Screen // New: Location History Screen
